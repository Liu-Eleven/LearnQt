...
**
** Created: Sat Jan 14 15:09:17 2012
...
static const char qt_meta_stringdata_MouseEvent[] = {
    "MouseEvent\0"
};
...
const QMetaObjectExtraData MouseEvent::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MouseEvent::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MouseEvent,
      qt_meta_data_MouseEvent, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MouseEvent::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MouseEvent))
